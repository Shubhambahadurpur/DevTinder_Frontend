        ...
        <div className="text-center">
            ...
            <div className="mt-5 flex flex-col items-center mb-5">
                {myConnections?.length ? myConnections?.map((connection, index) =>
                    <div className="flex bg-gray-300 py-5 w-2/6 mt-5 px-5 rounded-2xl shadow-xl" key={index}>
                        <img src={connection?.profilePhoto} alt="photo" className="rounded-xl h-30 w-30" />
